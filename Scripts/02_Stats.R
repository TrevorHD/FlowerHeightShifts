...
set.seed(19854)
hBoot_MPHD1_pdf <- ds.pdfBoot(ht_CN_NW$Height, rep(mean(ht_CN_NW_max$Max), 100), "MHD", "CN")
...
# The NW and W dispersal kernels display significant difference for CN and CA
set.seed(19854)
ds.pdfBoot(ht_CN_NW$Height, rep(mean(ht_CN_NW_max$Max), 100), "MHD", "CN", ks.only = TRUE)
...
set.seed(19854)
hBoot_MPHD1_ccdfRatio <- ds.ccdfRatioBoot(ht_CN_NW$Height, rep(mean(ht_CN_NW_max$Max), 100), "MHD", "CN")
hBoot_MPHD2_ccdfRatio <- ds.ccdfRatioBoot(ht_CN_W$Height, rep(mean(ht_CN_W_max$Max), 100), "MHD", "CN")
hBoot_MPHD3_ccdfRatio <- ds.ccdfRatioBoot(ht_CA_NW$Height, rep(mean(ht_CA_NW_max$Max), 100), "MHD", "CA")
hBoot_MPHD4_ccdfRatio <- ds.ccdfRatioBoot(ht_CA_W$Height, rep(mean(ht_CA_W_max$Max), 100), "MHD", "CA")
...
hBoot_WNW2_CCDFRatio[hBoot_WNW2_CCDFRatio[, 1] == 10, ]

# 50m warmed/unwarmed risk ratio with 95% BI
hBoot_WNW1_CCDFRatio[hBoot_WNW1_CCDFRatio[, 1] == 50, ]
hBoot_WNW2_CCDFRatio[hBoot_WNW2_CCDFRatio[, 1] == 50, ]
...
hBoot_MPHD1_ccdfRatio[hBoot_MPHD1_ccdfRatio[, 1] == 10, ]
hBoot_MPHD2_ccdfRatio[hBoot_MPHD2_ccdfRatio[, 1] == 10, ]
hBoot_MPHD3_ccdfRatio[hBoot_MPHD3_ccdfRatio[, 1] == 10, ]
hBoot_MPHD4_ccdfRatio[hBoot_MPHD4_ccdfRatio[, 1] == 10, ]

# 50m maximum/distribution risk ratio with 95% BI
hBoot_MPHD1_ccdfRatio[hBoot_MPHD1_ccdfRatio[, 1] == 50, ]
hBoot_MPHD2_ccdfRatio[hBoot_MPHD2_ccdfRatio[, 1] == 50, ]
hBoot_MPHD3_ccdfRatio[hBoot_MPHD3_ccdfRatio[, 1] == 50, ]
hBoot_MPHD4_ccdfRatio[hBoot_MPHD4_ccdfRatio[, 1] == 50, ]
...
# Set seed for RNG, then bootstrap CCDF ratios for M/HD CN and M/HD CA dispersal kernels
set.seed(19854)
hBoot_MHD1_ccdfRatio <- ds.ccdfRatioBoot(ht_CN_NW$Height, ht_CN_NW_max$Max, "MHD", "CN")
hBoot_MHD2_ccdfRatio <- ds.ccdfRatioBoot(ht_CN_W$Height, ht_CN_W_max$Max, "MHD", "CN")
hBoot_MHD3_ccdfRatio <- ds.ccdfRatioBoot(ht_CA_NW$Height, ht_CA_NW_max$Max, "MHD", "CA")
hBoot_MHD4_ccdfRatio <- ds.ccdfRatioBoot(ht_CA_W$Height, ht_CA_W_max$Max, "MHD", "CA")
...
##### [Extras] PDFs for dispersal kernel using max height distribution ------------------------------------
