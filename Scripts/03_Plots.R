##### [F1] Plot height distribution PDF, including observations -------------------------------------------
...
##### [F4] Plot max height point source vs overall height distribution CCDF ratio -------------------------
...
##### [FS1] Plot height distribution PDF with 95% bootstrap interval --------------------------------------
...
##### [FS2] Plot max height point source vs overall height distribution PDF (dispersal kernels) -----------
